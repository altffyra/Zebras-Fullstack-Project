...
const UserInformation = (props: UserInformationProps) => {
    ...
    const handleNewPasswordAgain: (e: ChangeEvent<HTMLInputElement>) => void = (e) => {
        ...
        {!update && !updatePassword
            ...
            <section className='user-container'>
                ...
                <div className="button-container">
                    <button className='change-btn' onClick={handlePassword}>Lösenord</button>
                    
                    <button className='change-btn' onClick={handleUpdate}>Uppgifter</button>
                </div>
            </section>
            : ""
        }
        ...
        : ''    
            ...
            <form className='user-container' onSubmit={(e) => handleSubmitPassword(e) }>
                ...
                <div className='user-info'>
                    ...
                    <input type="text" name="newpwagain" id="newpwagain" onChange={(e) => handleNewPasswordAgain(e)} />
                </div>
                <div className="button-container">
                    <button className='cancel-btn' onClick={(e) => handleCancel(e)}>Avbryt</button>
                    <button type='submit' className='update-btn'>Uppdatera</button>
